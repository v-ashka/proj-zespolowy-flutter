...
class _DashboardContainerState extends State<DashboardContainer> {
    ...
    switch (name) {
      ...
      case 'documents':
        var documentsData = {
          "document1": {
            "name": "Akt chrztu",
            "desc": "Plik z aktem chrztu",
            "created_at": "2022-05-26"
          },
          "document2": {
            "name": "Umowa najmu",
            "desc": "Umowa najmu mieszkania przy ulicy..",
            "created_at": "2020-03-03"
          },
          "document3": {
            "name": "Recepta",
            "desc": "recepta na okulary",
  ...
  Future<http.Response> createAlbum() {
    ...
    var test = http.post(
      Uri.parse(
          'http://parameters-rouge-casio-clients.trycloudflare.com/Samochod'),
