...
class _carListState extends State<carList> {
  ...
  Widget build(BuildContext context) {
    ...
    // print("isReceiptVisible? :${data['module_data'][0]['car_info']}");
        ...
        child: Padding(
          ...
          child:
                ...
                padding: const EdgeInsets.all(20),
                  itemCount: data['module_data'].length,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Text("${data['module_data'][index]["name"]}", style: TextStyle(
                                          fontSize: data['module_data'][index]['name']!.length > 15 ? (14):(18),
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text("${data['module_data'][index]['insurance_time']} dni",
                                                          style: TextStyle(
                                                          fontFamily: "Lato",
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text("${data['module_data'][index]['car_service_time']} dni",
                                                          style: TextStyle(
                                                              fontFamily: "Lato",
                                                              fontWeight: FontWeight.w400
                                                          ),
                                        ...
                                        child: Align(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: Image(
                                              ...
                                              image: NetworkImage("${data['module_data'][index]['car_info']['image']}"),
                                            ),
                                          ),
                                        ),
                                      ),
