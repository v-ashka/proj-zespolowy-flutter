                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text("${data['module_data'][index]["title"]}", style: TextStyle(
                              fontSize: data['module_data'][index]['title']!.length > 15 ? (14):(18),
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text("${data['module_data'][index]['dateCreated']}",
                                            style: TextStyle(
                                                fontFamily: "Lato",
                              ...
                              child: Align(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image(
                                    ...
                                    image: NetworkImage("${data['module_data'][index]['image']}"),
                                  ),
                                ),
                              ),
                            ),
