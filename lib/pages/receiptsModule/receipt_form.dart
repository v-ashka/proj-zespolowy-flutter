                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  hintText:
                                      receiptItem.dataZakupu ?? "Wybierz datę",
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    width: 120,
                                    child: TextFormField(
                                        initialValue: receiptItem.cena == null
                                            ? ("")
                                            : (receiptItem.cena.toString()),
                                        onSaved: (value) {
                                          receiptItem.cena = toDouble(value!);
                                        },
                                        cursorColor: Colors.black,
                          ...
                          children: [
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  TextFormField(
                                      initialValue: receiptItem.nazwaKategorii,
                                      onSaved: (value) {
                                ...
                                onChanged: (double value) {
                                  setState(() {
                                    ...
                                    receiptItem.waznoscGwarancji =
                                        _currentGuaranteeSliderVal.toInt();
                                  });
                                },
                              ),
                            ),
